    ...
    <main className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
        <div className="space-y-8">
          <section>
            <div className="flex items-center justify-between">
              <h2 className="text-sm uppercase tracking-[0.08em] text-ink-muted">Machine (Technical Consultant)</h2>
          ...
          <section>
            <h2 className="text-sm uppercase tracking-[0.08em] text-ink-muted">Fragrance direction (Fragrance Consultant)</h2>
        ...
        <aside className="space-y-4">
          <Card>
            <h2 className="text-sm uppercase tracking-[0.08em] text-ink-muted">Sign-off</h2>
            <div className="mt-3 space-y-3">
          ...
          <Card>
            <h2 className="text-sm uppercase tracking-[0.08em] text-ink-muted">Brief recap</h2>
